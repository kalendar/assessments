<div class="row">
         <div class="col-lg-12">
             <h2 class="page-header">Now that I know more about metacognitive evaluation, what can I do?</h2>
         </div>
         ...
         <div class="col-md-4 col-sm-6">
             <div class="panel panel-default text-center">
                 ...
                 <div class="panel-body">
                     <h4>See</h4>
                     <p>See how self-evaluation can influence the way you think, feel, and act</p>
